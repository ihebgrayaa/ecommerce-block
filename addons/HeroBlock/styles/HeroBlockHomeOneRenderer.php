...
/**
 * Class HeroBlockHomeOneRenderer
 *
 * Renders the "Home 1" style variation of the Hero Block.
 *
 * This renderer outputs a full-width slideshow based on Swiper,
 * using slide data defined via an ACF Repeater field.
 *
 ...
 *
 * @package EcommerceBlocks\HeroBlock\styles
 */
class HeroBlockHomeOneRenderer implements Renderer {

    /**
     * Render the Hero Block (Home 1 style).
     *
     * Generates a Swiper-based slideshow using slide data
     * provided by the Hero Block repeater field.
     *
     * If no slides are available, rendering is skipped
     * and an empty string is returned.
     *
     * Output buffering is used to construct complex HTML
     * markup with conditional elements.
     *
     * @param array $props Block properties passed by ACF/Gutenberg.
     *                     Expected structure:
     *                     - data['slider'] (array of slides)
     ...
     *                       - button (text + link)
     *
     * @return string Rendered HTML output for the Home 1 Hero Block style.
     */
